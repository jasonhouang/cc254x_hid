...
/*typedef struct {
    ...
    EXTERN __no_init volatile USBIRQ_DATA usbirqData @ USBIRQ_DATA_ADDR; ///< USBIRQ internal module data at fixed address
#else
    EXTERN volatile USBIRQ_DATA usbirqData; ///< USBIRQ internal module data
#endif
//-------------------------------------------------------------------------------------------------------
