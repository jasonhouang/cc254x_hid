/******************************************************************************
 ...
 @brief Interface to the magnometer driver
...
typedef enum
{
    MAG3110_OFF,          // Magnetometer Sleeping
    MAG3110_IDLE,			    // Magnetometer On and Configured
    MAG3110_DATA_READY,	  // Magnetometer On, Configured	and Data is Ready	
} Magnetometer_States_t;
