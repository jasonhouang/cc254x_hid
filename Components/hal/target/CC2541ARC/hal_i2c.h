/******************************************************************************
 ...
 @brief This module defines the HAL I2C API for the CC2533. Simplicity, speed
        and code size were the priorities over multi-master and/or multi-slave
        support which can easily be added as an enhancement to the detriment of
        the aforementioned.
