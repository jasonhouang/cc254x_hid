...
//
#define LL_DIRECT_TEST_DATA_00                         0x00
#define LL_DIRECT_TEST_DATA_0F                         0x0F
#define LL_DIRECT_TEST_DATA_55                         0x55
#define LL_DIRECT_TEST_DATA_AA                         0xAA
#define LL_DIRECT_TEST_DATA_F0                         0xF0
#define LL_DIRECT_TEST_DATA_FF                         0xFF
#define LL_DIRECT_TEST_DATA_NONE                       0xBA
//
...
typedef struct
{
  ...
  uint16 numEvents[ LL_MAX_NUM_DATA_CHAN ];
  uint16 numMissedEvts[ LL_MAX_NUM_DATA_CHAN ];
} perByChan_t;
 ...
 *
 * @brief       This LL API is used to reeive the Host's rejection to the LE
 ...
 * @param       None.
 *
 * @return      LL_STATUS_SUCCESS, LL_STATUS_ERROR_ILLEGAL_PARAM_COMBINATION
 */
extern llStatus_t LL_ValidConnTimeParams( uint16 connIntervalMin,
                                          uint16 connIntervalMax );
 ...
 *              LL_STATUS_ERROR_BAD_PARAMETER
 */
extern llStatus_t LL_EXT_ConnEventNotice( uint16 connId, uint8 taskID, uint16 taskEvent );
#endif // CTRL_CONFIG=(ADV_CONN_CFG | INIT_CFG)
