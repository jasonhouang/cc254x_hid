/******************************************************************************
 ...
 @brief This module implements the Application layer aspects for usability with
        a Serial Boot Loader for an 8051-based SOC using the UART/SPI transport.
        
        Note that this file is included only by the Application to be
        downloaded, not the SBL.
