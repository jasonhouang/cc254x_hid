/******************************************************************************
 ...
 @file  usb_board_cfg.h

 @brief This file implements the Temperature/Voltage Sample Application.
...
#define HAL_USB_INT_ENABLE()           /* Running in polled mode: st(P2IEN|= 0x20; IEN2|= 0x02;) */
#define HAL_USB_INT_DISABLE()          st( P2IEN&= ~0x20; )
#define HAL_USB_INT_CLEAR()            st( P2IFG= 0; P2IF= 0; )

#define HAL_USB_RESUME_INT_ENABLE()    /* Running in polled mode: st (USBCIE |= 0x02;) */
