/******************************************************************************
 ...
 @brief This module declares the Application layer aspects for usability with a
        Universal Boot Loader for an 8051-based SOC using the USB transport by
        MSD.
        
        Note that this file is included by both the UBL and the Application to
        be downloaded, thus any change to the data structures herewithin
        require a physical re-programming of the UBL.
