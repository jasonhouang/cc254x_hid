/******************************************************************************
 ...
 @brief This module implements the main functionality of a Universal Boot
        Loader for an 8051-based SOC via the USB by MSD. The functionality is
        similar to ZStack OnBoard.c and hal_startup.c.
