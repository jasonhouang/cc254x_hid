/******************************************************************************
 ...
 @brief Glucose Collector indication and notification handling routines.
...
{ 
  if (pMsg->method == ATT_ERROR_RSP)
  {
     ...
     LCD_WRITE_STRING_VALUE("Handle:  ", pRsp->handle, 10, HAL_LCD_LINE_2);
     LCD_WRITE_STRING_VALUE("errCode: ", pRsp->errCode, 10, HAL_LCD_LINE_3);
  }
