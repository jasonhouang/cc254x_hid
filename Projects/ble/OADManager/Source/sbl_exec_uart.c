/******************************************************************************
 ...
 @file  sbl_exec_uart.c

 @brief This file contains the interface to the H/W transport driver by UART
        which act as a Serial Boot Loader in order to get an OAD image into the
        OAD Dongle's internal flash.
