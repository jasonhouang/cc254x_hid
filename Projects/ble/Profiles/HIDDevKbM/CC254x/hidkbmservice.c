...
bStatus_t HidKbM_AddService( void )
{
  ...
  hidReportMouseInClientCharCfg = (gattCharCfg_t *)osal_mem_alloc( sizeof(gattCharCfg_t) *
                                                                   linkDBNumConns);
  ...
  {
    osal_mem_free( hidReportMouseInClientCharCfg );
    
    return ( bleMemAllocError );
  }
  
  hidReportCCInClientCharCfg = (gattCharCfg_t *)osal_mem_alloc( sizeof(gattCharCfg_t) *
                                                                linkDBNumConns);
  ...
  if (hidReportBootKeyInClientCharCfg == NULL)
  {
    osal_mem_free( hidReportMouseInClientCharCfg );
    osal_mem_free( hidReportKeyInClientCharCfg );
    osal_mem_free( hidReportCCInClientCharCfg );
  ...
  status = GATTServApp_RegisterService( hidAttrTbl, GATT_NUM_ATTRS( hidAttrTbl ),
                                        GATT_MAX_ENCRYPT_KEY_SIZE, &hidKbdMsCBs );
  ...
  hidRptMap[0].pCccdAttr = &hidAttrTbl[HID_REPORT_MOUSE_IN_CCCD_IDX];
  ...
  hidRptMap[1].pCccdAttr = &hidAttrTbl[HID_REPORT_KEY_IN_CCCD_IDX];
  ...
  hidRptMap[2].pCccdAttr = &hidAttrTbl[HID_REPORT_CC_IN_CCCD_IDX];
  ...
  hidRptMap[4].pCccdAttr = &hidAttrTbl[HID_BOOT_KEY_IN_CCCD_IDX];
  ...
  hidRptMap[6].pCccdAttr = &hidAttrTbl[HID_BOOT_MOUSE_IN_CCCD_IDX];
