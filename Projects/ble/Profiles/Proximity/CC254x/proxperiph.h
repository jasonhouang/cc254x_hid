/******************************************************************************
 ...
 @brief This file contains Proximity - Peripheral header file.
...
#ifndef PROXIMITYPERIPHERAL_H
#define PROXIMITYPERIPHERAL_H
...
#define LINK_LOSS_SERVICE_UUID          0x1500
#define IMMEDIATE_ALERT_SERVICE_UUID    0x1501
#define TX_PWR_LEVEL_SERVICE_UUID       0x1502
  
// Proximity Profile Attribute UUIDs
#define PROXIMITY_ALERT_LEVEL_UUID      0x1505
#define PROXIMITY_TX_PWR_LEVEL_UUID     0x1506
...
/*
 * ProxPeriph_InitService- Initializes the Proximity Peripheral service by
 ...
 */
extern bStatus_t ProxPeriph_AddService( uint32 services );

/*
 * ProxPeriph_RegisterAppCBs - Registers the application callback function.
 *                    Only call this function once.
 *
 *    appCallbacks - pointer to application callbacks.
 */
extern bStatus_t ProxPeriph_RegisterAppCBs( proxPeriphCBs_t *appCallbacks );


/*
 * ProxPeriph_SetParameter - Set a Proximity Peripheral parameter.
 *
 ...
 *          uint16 pointer).
 */
extern bStatus_t ProxPeriph_SetParameter( uint8 param, uint8 len, void *value );
  
/*
 * ProxPeriph_GetParameter - Get a Proximity Peripheral parameter.
 *
 *    param - Profile parameter ID
 *    value - pointer to data to write.  This is dependent on
 *          the parameter ID and WILL be cast to the appropriate 
 ...
 *          uint16 pointer).
 */
extern bStatus_t ProxPeriph_GetParameter( uint8 param, void *value );
