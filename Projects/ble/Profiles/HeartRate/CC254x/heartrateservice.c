 ...
 * LOCAL FUNCTIONS
 */
static bStatus_t heartRate_ReadAttrCB(uint16 connHandle, gattAttribute_t *pAttr, 
...
bStatus_t HeartRate_AddService(uint32 services)
{
  ...
  heartRateMeasClientCharCfg = (gattCharCfg_t *)osal_mem_alloc( sizeof(gattCharCfg_t) *
                                                                linkDBNumConns );
