/******************************************************************************
 ...
 @file  magnetometerservice.c

 @brief Magnetometer Service
...
#define SENSOR_SERVICE_UUID     MAGNETOMETER_SERV_UUID
#define SENSOR_DATA_UUID        MAGNETOMETER_DATA_UUID
#define SENSOR_CONFIG_UUID      MAGNETOMETER_CONF_UUID
#define SENSOR_PERIOD_UUID      MAGNETOMETER_PERI_UUID

#define SENSOR_SERVICE          MAGNETOMETER_SERVICE
#define SENSOR_DATA_LEN         MAGNETOMETER_DATA_LEN

#ifdef USER_DESCRIPTION
#define SENSOR_DATA_DESCR       "Magn. Data"
#define SENSOR_CONFIG_DESCR     "Magn. Conf."
#define SENSOR_PERIOD_DESCR     "Magn. Period"
#endif
 ...
 */
bStatus_t Magnetometer_AddService( void )
{
  bStatus_t ret;
 ...
 */
bStatus_t Magnetometer_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
