/******************************************************************************
 ...
 @file  gapperiphbondmgr.h

 @brief @mainpage TI BLE GAP Peripheral Bond Manager
        
        This GAP profile manages bonded connections between this slave device
        and  connected master devices.<BR><BR>
        ...
        This GAP Bond Manager will handle all of the pairing and bonding
        actions  automatically and can be controlled by setting control
        parameters:<BR> GAPBondMgr_SetParameter()<BR>
