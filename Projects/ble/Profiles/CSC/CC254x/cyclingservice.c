/******************************************************************************
 ...
 @file  cyclingservice.c

 @brief This file contains the Cycling Speed and Cadence (CSC) service for use
        with the CyclingApp sample application.
...
bStatus_t Cycling_AddService( uint32 services )
{
  ...
  cyclingMeasClientCharCfg = (gattCharCfg_t *)osal_mem_alloc( sizeof ( gattCharCfg_t ) * 
                                                              linkDBNumConns );
  ...
  // Allocate Client Characteristic Configuration table
  cyclingCommandClientCharCfg = (gattCharCfg_t *)osal_mem_alloc( sizeof ( gattCharCfg_t ) * 
                                                                 linkDBNumConns );
  if ( cyclingCommandClientCharCfg == NULL )
  {
    // Free already allocated data
    osal_mem_free( cyclingMeasClientCharCfg );
