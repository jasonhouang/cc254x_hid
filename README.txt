...
For guide on how to port to the latest SDK release, visit the wiki page here:

http://processors.wiki.ti.com/index.php/LPRF_BLE_Porting_Projects

For additional sample applications, porting guides, and documentation, visit the Texas 
